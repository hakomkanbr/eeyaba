...
const Contact = () => {
  const sendForm = (e: any) => {
    e.preventDefault();
    console.info('sdsdfdgdfgfgh');
  };

  return (
    <section id="contact" className="overflow-hidden py-16" style={{
              ...
              <form onSubmit={sendForm}>
                <div className="-mx-4 flex flex-wrap">
                  ...
                  <div className="w-full px-4">
                    <button
                      type="submit"
                      className="rounded-sm bg-[#031866db] px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark"
                    >
                      Submit Ticket
                    </button>
                  </div>
